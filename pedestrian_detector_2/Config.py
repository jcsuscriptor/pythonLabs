...
datasetRoot = 'D:\\Labs\\python\\Pedestrian_Detector\\'
...
testFolderPath = '/Volumes/TOSHIBA EXT/Datasets/INRIA_dummy/Test/FramesPos'
annotationsFolderPath = '/Volumes/TOSHIBA EXT/Datasets/INRIA_dummy/Test/Annotations'
...
modelPath = datasetRoot + 'Models/'+model+'_'+modelFeatures+'.model'
